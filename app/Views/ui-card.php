                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="/images/small/img-1.jpg" class="img-fluid rounded-start h-100"
                                        alt="img-1">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="row g-0">
                                ...
                                <div class="col-md-4">
                                    <img src="/images/small/img-2.jpg" class="img-fluid rounded-end h-100"
                                        alt="img-2">
                                </div> <!-- end col -->
                            </div> <!-- end row-->
                        </div> <!-- end card -->
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a href="javascript:void(0);" class="btn btn-primary mt-2 stretched-link">Go
                                    somewhere</a>
                            </div> <!-- end card-body -->
                        </div> <!-- end card -->
                    </div> <!-- end col-->
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-2"><a href="javascript:void(0);"
                                        class="text-primary stretched-link">Card with stretched link</a></h5>
                                <p class="card-text">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title mb-2"><a href="javascript:void(0);" class="stretched-link">Card
