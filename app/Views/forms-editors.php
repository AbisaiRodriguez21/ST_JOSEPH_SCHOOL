                        ...
                        <div class="card-body">
                            <h5 class="card-title mb-1 anchor" id="overview">
                                Overview <a class="btn btn-sm btn-outline-success rounded-2 float-end"
                                            href="https://quilljs.com/" target="_blank"> Official Website </a>
                            </h5>
                            <p class="text-muted mb-3">Quilljs is a lightweight and powerful datetime picker.</p>

                            <h5 class="mt-2">Usage</h5>
                            <p class="mb-0">Quilljs's CSS and Javascript files are bundled in the
                                <code>vender.min.css</code> and <code>vendor.js</code> and globally included in all
                                pages.</p>
                        </div><!-- end card-body -->
                    </div><!-- end card -->
                            ...
                            <div class="highlight">
                                <div class="highlight-toolbar">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <a href="#snow-editor-html" data-bs-toggle="tab" aria-expanded="false"
                                               class="nav-link active">
                                                <span class="fs-12 text-uppercase">html</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#snow-editor-javascript" data-bs-toggle="tab" aria-expanded="true"
                                               class="nav-link">
                        ...
                        <div class="card-body">
                            ...
                            <div class="highlight">
                                <div class="highlight-toolbar">
                                    <ul class="nav nav-pills">
                                        <li class="nav-item">
                                            <a href="#bubble-editor-html" data-bs-toggle="tab" aria-expanded="false"
                                               class="nav-link active">
                                                <span class="fs-12 text-uppercase">html</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#bubble-editor-javascript" data-bs-toggle="tab"
