...
<head>
    <?= view("partials/title-meta", ["title" => "Dashboard Profesor"]); ?>
    ...
    <div class="wrapper">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Panel del Profesor</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <!-- Tarjetas Dinámicas de Materias -->
                    <?php if (!empty($materias)): ?>
                        <?php foreach ($materias as $m): ?>
                            <div class="col-md-6 col-lg-3">
                                <a href="<?= base_url('profesor/calificar/' . $m['id_grado'] . '/' . $m['id_materia']) ?>" class="text-decoration-none">
                                    <div class="widget-card">
                                        <div class="widget-header">
                                            <span><?= esc($m['nombreGrado']) ?></span>
                                            <i class="mdi mdi-book-open-page-variant"></i>
                                        </div>
                                        <div class="widget-body">
                                            <span class="widget-title" style="color:#5c6bc0; font-weight:bold;"><?= esc($m['nombre_materia']) ?></span>
                    ...
                    <?php else: ?>
                        <div class="col-12 mb-4">
                            <div class="alert alert-info border-0 shadow-sm">
                                <i class="mdi mdi-information-outline me-2"></i> Aún no tienes materias asignadas para el ciclo escolar actual.
                            </div>
                        </div>
                    <?php endif; ?>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                fetch('<?= base_url("profesor/actualizar-password") ?>', {
                        method: 'POST',
                        body: formData,
                        headers: {
