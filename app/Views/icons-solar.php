          ...
          <div class="page-content">
               ...
               <div class="container-fluid">
                    ...
                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-3">
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:leaf-bold-duotone"
                                        class="fs-2 text-primary"></iconify-icon>
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:bookmark-circle-bold-duotone"
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:black-hole-line-duotone"
                                        class="fs-2 text-info"></iconify-icon>
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:chat-round-unread-bold-duotone"
                                        class="fs-2 text-dark"></iconify-icon>
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:compass-big-bold-duotone"
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:confetti-minimalistic-line-duotone"
                                        class="fs-2"></iconify-icon>
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:dollar-bold-duotone"
                                        class="fs-2 text-danger"></iconify-icon>
                         ...
                         <div class="card icon-box">
                              <div class="card-body d-flex flex-column align-items-center justify-content-center">
                                   <iconify-icon icon="solar:electric-refueling-bold-duotone"
                                        class="fs-2"></iconify-icon>
                    ...
                    <div class="my-4 text-center">
                         <a href="https://icon-sets.iconify.design/solar/" target="_blank" class="btn btn-primary">View
                              All Icons</a>
                    </div>
